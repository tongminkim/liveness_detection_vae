"""
Evaluate Original Path Models on Final Test Set
Using Two-Stage Gaussian Filtering with PCA_10D

Models:
1. stage2_method1_margin_fixed/stage2_method1_best.pt
2. stage2_method2_discriminator/stage2_method2_best.pt
...
# Two models to evaluate (original paths)
MODELS = {
    'method1_margin_fixed': '/home/elicer/liveness_detection/model1/runs/stage2_method1_margin_fixed/stage2_method1_best.pt',
    'method2_discriminator': '/home/elicer/liveness_detection/model1/runs/stage2_method2_discriminator/stage2_method2_best.pt'
}

OUTPUT_DIR = "runs/original_models_evaluation"
...
def plot_comparison(results_dict, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'original_models_comparison.png'), dpi=150, bbox_inches='tight')
    plt.close()
    print(f"Saved comparison plot to: {os.path.join(output_dir, 'original_models_comparison.png')}")
...
def main():
    print("="*80)
    print("Evaluating Original Path Models on Final Test Set")
    print("="*80)
    ...
    print("\n{:<30} {:<25} {:<25}".format("Metric", "method1_margin_fixed", "method2_discriminator"))
    print("-"*80)
    print("{:<30} {:<25.4f} {:<25.4f}".format("Accuracy",
        results_dict['method1_margin_fixed']['accuracy'],
        results_dict['method2_discriminator']['accuracy']))
    print("{:<30} {:<25.4f} {:<25.4f}".format("Precision",
        results_dict['method1_margin_fixed']['precision'],
        results_dict['method2_discriminator']['precision']))
    print("{:<30} {:<25.4f} {:<25.4f}".format("Recall",
        results_dict['method1_margin_fixed']['recall'],
        results_dict['method2_discriminator']['recall']))
    print("{:<30} {:<25.4f} {:<25.4f}".format("F1-Score",
        results_dict['method1_margin_fixed']['f1'],
        results_dict['method2_discriminator']['f1']))
    print("{:<30} {:<25.4f} {:<25.4f}".format("Specificity",
        results_dict['method1_margin_fixed']['specificity'],
        results_dict['method2_discriminator']['specificity']))
    print("{:<30} {:<25.4f} {:<25.4f}".format("Explained Variance",
        results_dict['method1_margin_fixed']['explained_variance'],
        results_dict['method2_discriminator']['explained_variance']))
    print("-"*80)

    # Determine best model
    if results_dict['method1_margin_fixed']['f1'] > results_dict['method2_discriminator']['f1']:
        best_model = 'method1_margin_fixed'
    else:
