"""
Evaluate Stage 1 Pretrained Model: Two-Stage Gaussian Filtering with PCA_10D
...
MODEL_CHECKPOINT = "runs/stage1_pretrain/stage1_pretrained.pt"
OUTPUT_DIR = "runs/stage1_pretrain_evaluation_pca10d"
...
def plot_confusion_matrix(cm, accuracy, f1, output_path):
    ...
    title = 'Confusion Matrix (Stage 1 Pretrained)\n'
...
def plot_detailed_metrics(results, output_path):
    ...
    axes[0].set_title('Performance Metrics (Stage 1 Pretrained)\n(PCA_10D, Conf1=0.95, Conf2=0.70)',
    ...
    bars2 = axes[1].bar(categories, stats_values, color=stats_colors, alpha=0.8,
...
def main():
    print("="*80)
    print("Stage 1 Pretrained Model Evaluation")
    print("Two-Stage Gaussian Filtering with PCA_10D")
    print("="*80)
    ...
    # ========================================
    print("\n" + "="*80)
    print("EVALUATION RESULTS (STAGE 1 PRETRAINED)")
    print("="*80)
    ...
    plot_detailed_metrics(
        results,
        os.path.join(OUTPUT_DIR, 'detailed_metrics.png')
    )
